                            ...
                            <div class=" d-flex flex-column gap-40">
                                ...
                                <div class="border border-radius-8 ">
                                    ...
                                    <div class="bg-white px-40 ">
                                        <div class="">
                                            <div
                                                class="d-flex flex-row  fw-medium font-16 radio-wrapper overflow-x-scroll py-32">
                                                <div
                                ...
                                <div class="border border-radius-8 ">
                                    ...
                                    <div class="bg-white px-40">
                                        <div class="">
                                            <div
                                                class="d-flex flex-row  border-l fw-medium font-16 radio-wrapper overflow-x-scroll py-32">
                                                <div
                                                    class="d-flex flex-column justify-content-between py-48 border-r w-100px">
                                                    <p>promo</p>
                                                    <p>Mug </p>
